...
export class DiscountTableComponent extends AbstractComponent implements OnInit {
  ...
  discounttypeField = new FormControl();
  discountstatusField = new FormControl();
  ...
  async loadData(): Promise<any> {
    ...
    pageRequest.addSearchCriteria('discounttype', this.discounttypeField.value);
    pageRequest.addSearchCriteria('discountstatus', this.discountstatusField.value);
