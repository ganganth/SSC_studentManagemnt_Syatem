...
@Component({
  selector: 'app-clssubject-update-sub-form',
  templateUrl: './clssubject-update-sub-form.component.html',
  styleUrls: ['./clssubject-update-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ClssubjectUpdateSubFormComponent),
      multi: true
    }, {
...
export class ClssubjectUpdateSubFormComponent extends AbstractSubFormComponent<Clssubject> implements OnInit{
