...
@Component({
  selector: 'app-yearterm-sub-form',
  templateUrl: './yearterm-sub-form.component.html',
  styleUrls: ['./yearterm-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => YeartermSubFormComponent),
      multi: true
    }, {
...
export class YeartermSubFormComponent extends AbstractSubFormComponent<Yearterm> implements OnInit{
