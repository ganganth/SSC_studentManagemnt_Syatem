...
public class EmployeeController{
    ...
    public Page<Employee> getAllBasic(PageQuery pageQuery, HttpServletRequest request){
        accessControlManager.authorize(request, "No privilege to get all employees' basic data", UsecaseList.SHOW_ALL_EMPLOYEES, UsecaseList.ADD_CLS, UsecaseList.UPDATE_CLS, UsecaseList.ADD_CLS, UsecaseList.UPDATE_CLS, UsecaseList.ADD_MATERIAL, UsecaseList.UPDATE_MATERIAL, UsecaseList.ADD_SUBJECT, UsecaseList.UPDATE_SUBJECT, UsecaseList.ADD_TIMETABLE, UsecaseList.UPDATE_TIMETABLE);
