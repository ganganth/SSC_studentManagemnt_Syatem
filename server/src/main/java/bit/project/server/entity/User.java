...
public class User{
    ...
    @ManyToOne
    @JsonIgnoreProperties({"creator","tocreation",""})
    ...
    public User(Integer id, String username, Student student, Employee employee, Guardian guardian){
        this.id = id;
    ...
    public boolean isSuperAdmin(){
        if (this.student != null) return false;
        if (this.employee != null) return false;
        if (this.guardian != null) return false;
        return true;
    }
